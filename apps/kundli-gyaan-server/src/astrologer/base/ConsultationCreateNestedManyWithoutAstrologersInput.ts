...
@InputType()
class ConsultationCreateNestedManyWithoutAstrologersInput {
...
export { ConsultationCreateNestedManyWithoutAstrologersInput as ConsultationCreateNestedManyWithoutAstrologersInput };
