...
@InputType()
class PredictionUpdateManyWithoutConsultationsInput {
...
export { PredictionUpdateManyWithoutConsultationsInput as PredictionUpdateManyWithoutConsultationsInput };
