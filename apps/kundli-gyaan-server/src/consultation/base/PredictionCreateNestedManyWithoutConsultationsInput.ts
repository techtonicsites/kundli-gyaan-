...
@InputType()
class PredictionCreateNestedManyWithoutConsultationsInput {
...
export { PredictionCreateNestedManyWithoutConsultationsInput as PredictionCreateNestedManyWithoutConsultationsInput };
