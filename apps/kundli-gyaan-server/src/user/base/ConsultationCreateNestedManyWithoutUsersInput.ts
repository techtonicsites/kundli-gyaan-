...
@InputType()
class ConsultationCreateNestedManyWithoutUsersInput {
...
export { ConsultationCreateNestedManyWithoutUsersInput as ConsultationCreateNestedManyWithoutUsersInput };
